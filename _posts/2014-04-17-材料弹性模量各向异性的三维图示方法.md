...
122
123
124</pre></div></td><td class="code"><div class="highlight" style="background: #f8f8f8"><pre style="line-height: 125%"><span style="color: #AA22FF; font-weight: bold">function</span> <span style="color: #00A000">Aniso</span>
clc;clear;close all;
...
<span style="color: #008800; font-style: italic">% 正交晶系测试</span>
C(<span style="color: #666666">1</span>,<span style="color: #666666">1</span>)=<span style="color: #666666">115.9</span>; C(<span style="color: #666666">1</span>,<span style="color: #666666">2</span>)=<span style="color: #666666">35.3</span>;  C(<span style="color: #666666">1</span>,<span style="color: #666666">3</span>)=<span style="color: #666666">46.8</span>;
              C(<span style="color: #666666">2</span>,<span style="color: #666666">2</span>)=<span style="color: #666666">174.1</span>; C(<span style="color: #666666">2</span>,<span style="color: #666666">3</span>)=<span style="color: #666666">38.7</span>;
                            C(<span style="color: #666666">3</span>,<span style="color: #666666">3</span>)=<span style="color: #666666">153.1</span>;
C(<span style="color: #666666">4</span>,<span style="color: #666666">4</span>)=<span style="color: #666666">50.9</span>;  C(<span style="color: #666666">5</span>,<span style="color: #666666">5</span>)=<span style="color: #666666">70.2</span>;  C(<span style="color: #666666">6</span>,<span style="color: #666666">6</span>)=<span style="color: #666666">26.6</span>;

<span style="color: #008800; font-style: italic">% 立方晶系</span>
<span style="color: #008800; font-style: italic">% C11=240.20; C12= 125.60; C44= 28.20; % Nb</span>
...
<span style="color: #008800; font-style: italic">% 查找极值, 可用于任意晶系</span>
A=<span style="color: #666666">0</span>; Emin=min(E(:)); Emax=max(E(:));
...
<span style="color: #008800; font-style: italic">% 作颜色映射曲面</span>
...
<span style="color: #008800; font-style: italic">% 作曲面在做坐标面的投影, f 控制投影位置</span>
hold on
xr=xlim; yr=ylim; zr=zlim; f=<span style="color: #666666">1.2</span>;
mesh(<span style="color: #AA22FF">zeros</span>(<span style="color: #AA22FF">size</span>(x))<span style="color: #666666">+</span>f<span style="color: #666666">*</span>xr(<span style="color: #666666">1</span>), y, z, E)
mesh(x, <span style="color: #AA22FF">zeros</span>(<span style="color: #AA22FF">size</span>(y))<span style="color: #666666">-</span>f<span style="color: #666666">*</span>yr(<span style="color: #666666">1</span>), z, E)
mesh(x, y, <span style="color: #AA22FF">zeros</span>(<span style="color: #AA22FF">size</span>(z))<span style="color: #666666">+</span>f<span style="color: #666666">*</span>zr(<span style="color: #666666">1</span>), E)
hold off

<span style="color: #008800; font-style: italic">% 作模量的某一切面图, 使用前先注释掉上面的 surf 语句</span>
