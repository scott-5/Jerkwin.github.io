...
22
23
24</pre></div></td><td class="code"><div class="highlight"><pre style="line-height:125%"><span></span><span style="color: #B8860B">chg</span><span style="color: #666666">=</span>charge.dat    <span style="color: #008800; font-style: italic"># 电荷文件</span>
...
BEGIN <span style="color: #666666">{</span>
	<span style="color: #B8860B">FMT</span><span style="color: #666666">=</span><span style="color: #BB4444">&quot;%s%15.9f%15.9f%15.9f\n&quot;</span>
	<span style="color: #B8860B">FMT</span><span style="color: #666666">=</span><span style="color: #BB4444">&quot;%s%8.1E%8.1E%8.1E\n&quot;</span>
	<span style="color: #AA22FF; font-weight: bold">while</span><span style="color: #666666">(</span>getline&lt;chg<span style="color: #666666">)</span> <span style="color: #AA22FF; font-weight: bold">if</span><span style="color: #666666">(</span><span style="color: #B8860B">$1</span>!~/#/<span style="color: #666666">)</span> q<span style="color: #666666">[</span><span style="color: #B8860B">$1</span><span style="color: #666666">]=</span><span style="color: #B8860B">$2</span>
<span style="color: #666666">}</span>
<span style="color: #666666">{</span>	print
	getline Natm; print Natm
	<span style="color: #B8860B">qvx</span><span style="color: #666666">=</span>0; <span style="color: #B8860B">qvy</span><span style="color: #666666">=</span>0; <span style="color: #B8860B">qvz</span><span style="color: #666666">=</span>0
	<span style="color: #AA22FF; font-weight: bold">for</span><span style="color: #666666">(</span><span style="color: #B8860B">i</span><span style="color: #666666">=</span>1; i&lt;<span style="color: #666666">=</span>Natm; i++<span style="color: #666666">)</span> <span style="color: #666666">{</span>
		getline
		qvx +<span style="color: #666666">=</span> q<span style="color: #666666">[</span>i<span style="color: #666666">]</span>*<span style="color: #AA22FF; font-weight: bold">$(</span>NF-2<span style="color: #AA22FF; font-weight: bold">)</span>; qvy +<span style="color: #666666">=</span> q<span style="color: #666666">[</span>i<span style="color: #666666">]</span>*<span style="color: #AA22FF; font-weight: bold">$(</span>NF-1<span style="color: #AA22FF; font-weight: bold">)</span>; qvz +<span style="color: #666666">=</span> q<span style="color: #666666">[</span>i<span style="color: #666666">]</span>*<span style="color: #B8860B">$NF</span>
		<span style="color: #AA22FF; font-weight: bold">if</span><span style="color: #666666">(</span>i!<span style="color: #666666">=</span>Natm<span style="color: #666666">)</span> <span style="color: #AA22FF">printf</span> FMT, substr<span style="color: #666666">(</span><span style="color: #B8860B">$0</span>,1,44<span style="color: #666666">)</span>, 0,0,0
		<span style="color: #AA22FF; font-weight: bold">else</span> <span style="color: #AA22FF">printf</span> FMT, substr<span style="color: #666666">(</span><span style="color: #B8860B">$0</span>,1,44<span style="color: #666666">)</span>, qvx, qvy, qvz
	<span style="color: #666666">}</span>
	getline; print
...
<span style="color: #AA22FF">echo</span> <span style="color: #666666">0</span> | gmx trjconv -f <span style="color: #B8860B">$vqgro</span> -o <span style="color: #B8860B">$vqtrr</span>
</pre></div>
</td></tr></table>
