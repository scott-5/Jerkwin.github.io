...
![](https://jerkwin.github.io/pic/2016/frgmol_all.png)

这是一个由晶体文件创建的体系, 里面包含12个分子, 每个分子又包含65原子.

![](https://jerkwin.github.io/pic/2016/frgmol_frg.png)
...
![](https://jerkwin.github.io/pic/2016/frgmol_open.png)

打开所有这些分子后, 点击Y形图标将所有12个分子排列好

![](https://jerkwin.github.io/pic/2016/frgmol_grp.png)

菜单`Edit | Connection`打开连接编辑器, 在第一个分子中随便选择一个原子, 然后点击`Enable Autofixing`, 后面所有分子就会自动调整顺序.

![](https://jerkwin.github.io/pic/2016/frgmol_autofix.png)
